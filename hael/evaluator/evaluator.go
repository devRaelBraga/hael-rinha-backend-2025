...
func evalPrefixExpression(operator string, right object.Object) object.Object {
	...
	default:
		return newError("unknownA operator: %s%s", operator, right.Type())
	}
}
...
func evalInfixExpression(operator string, left, right object.Object) object.Object {
	...
	default:
		return newError("unknownS operator: %s %s %s", left.Type(), operator, right.Type())
	}
}
...
func evalMinusOperatorExpression(right object.Object) object.Object {
	if right.Type() != object.INTEGER_OBJ {
		return newError("unknownB operator: -%s", right.Type())
	}
...
func evalIntegerInfixExpression(operator string, left, right object.Object) object.Object {
	...
	case "!=":
		return nativeBooleanObject(leftVal != rightVal)
	default:
		return newError("unknownCC operator: %s %s %s", left.Type(), operator, right.Type())
	}
}
